...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "John Doe", "johndoe@company.com", new DateTime(1980, 6, 22), 2000.00, d1);
            Seller s2 = new Seller(2, "Mary Sue", "marysue@company.com", new DateTime(1984, 2, 23), 2000.00, d1);
            Seller s3 = new Seller(3, "Guy Cool", "cool@company.com", new DateTime(1990, 3, 18), 2000.00, d2);
            Seller s4 = new Seller(4, "Stephen Queen", "squeen@company.com", new DateTime(1979, 1, 28), 3000.00, d2);
            Seller s5 = new Seller(5, "George Martian", "georgem@company.com", new DateTime(1997, 12, 02), 2000.00, d3);
            Seller s6 = new Seller(6, "Laura Arual", "laura@company.com", new DateTime(1990, 6, 10), 2500.00, d2);
